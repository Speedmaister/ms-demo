    ...
    sealed partial class App : Application
    {
        ...
        protected override void OnLaunched(LaunchActivatedEventArgs args)
        {
            ...
            if (rootFrame.Content == null)
            {
                ...
                // parameter
                if (!rootFrame.Navigate(typeof(LoginRegisterPage), args.Arguments))
                {
        ...
        protected async override void OnSearchActivated(Windows.ApplicationModel.Activation.SearchActivatedEventArgs args)
        {
            ...
            if (frame == null)
            {
                ...
                frame = new Frame();
                FreeJustBelot.Common.SuspensionManager.RegisterFrame(frame, "AppFrame");
                ...
                if (args.PreviousExecutionState == ApplicationExecutionState.Terminated)
                {
                    ...
                    try
                    {
                        await FreeJustBelot.Common.SuspensionManager.RestoreAsync();
                    }
                    catch (FreeJustBelot.Common.SuspensionManagerException)
                    {
            ...
            frame.Navigate(typeof(SearchForPeople), args.QueryText);
